  ...
  <div class="">
    <div class="flex md:!flex-row flex-col items-center justify-center mb-6 mt-14 gap-2">
      <div class="w-16 rounded-full">
        <img class="w-full h-full object-contain" src="https://vault.astrostake.xyz/brand-kit/icon/favicon_white.svg" alt="AstroStake Logo" />
      </div>
...
<style scoped>
/*
  Blok style scoped ini bisa dihapus sepenuhnya
  karena Anda sudah tidak menggunakan SVG inline.
*/
/*
.logo path{
  fill: #171d30;
